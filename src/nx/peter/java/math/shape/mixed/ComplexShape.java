package nx.peter.java.math.shape.mixed;

import nx.peter.java.math.shape.AbstractShape;
import nx.peter.java.math.shape.Hole;
...
public class ComplexShape extends AbstractShape<ComplexShape> implements nx.peter.java.math.shape.ComplexShape<ComplexShape> {
	...
	@SafeVarargs
	@Override
	public final <S extends Shape> void set(S... shapes) {
	...
	@Override
	public <S extends Shape> ComplexShape remove(List<S> shape) {
		for (Shape s : shapes)
			if (contains(s))
