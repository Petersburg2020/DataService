...
public class ComplexShape extends Solid<ComplexShape> implements nx.peter.java.math.shape.ComplexShape<ComplexShape> {
	...
	@Override
	public ComplexShape add(Shape... shapes) {
	...
	@Override
	public ComplexShape remove(Shape... shapes) {
	...
	public List<nx.peter.java.math.shape.solid.Hole> getSolidHoles() {
		List<nx.peter.java.math.shape.solid.Hole> holes = new ArrayList<>();
		for (Shape s : shapes)
			if (s.isHole())
				holes.add((nx.peter.java.math.shape.solid.Hole) s);
		return holes;
	}
	...
	public String getShape() {
		return shapeCount() == 1 ? toShape().getShape() : super.getShape();
	}


	@Override
	public String toString() {
		return (shapeCount() == 1 ? shapes.get(0).toString() : 
			super.toString() +
